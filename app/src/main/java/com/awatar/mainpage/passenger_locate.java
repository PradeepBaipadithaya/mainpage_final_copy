...
import com.awatar.mainpage.databinding.ActivityPassengerLocate3Binding;
...
public class passenger_locate extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private ActivityPassengerLocate3Binding binding;
    ...
    public double locationLat_user = 14.132;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPassengerLocate3Binding.inflate(getLayoutInflater());
